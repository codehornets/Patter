...
| `persist` | `boolean \| string` | No | — | Persist the dashboard's call history to disk so it survives process restarts. See [Persistent dashboard history](#persistent-dashboard-history) below. |
